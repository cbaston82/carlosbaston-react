myScript = function () {
  ...
  if (
    wScroll >
    document.querySelector('#about-section').offsetTop - wHeight / 3
  ) {
    document
      .querySelector('#about-section .container')
      .classList.add('isShowing');
  }

  if (
    wScroll >
    document.querySelector('#knowledge-section').offsetTop - wHeight / 3
  ) {
    document
      .querySelector('#knowledge-section .container')
      .classList.add('isShowing');
  }
  ...
  if (
    wScroll >
    document.querySelector('#contact-section').offsetTop - wHeight / 3
  ) {
    document
      .querySelector('#contact-section .container')
      .classList.add('isShowing');
  }

  if (
    wScroll >
    document.querySelector('#testimonials-section').offsetTop - wHeight / 3
  ) {
    document
      .querySelector('#testimonials-section .container')
      .classList.add('isShowing');
  }
};
